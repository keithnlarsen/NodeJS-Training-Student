...
var digitalPhoneTests = new JsUnitTest.Unit.Runner({
	...
	setup: function() {
		dp = new Gridroad.DigitalPhone("4035551212");
	},
...
var docsisTests = new JsUnitTest.Unit.Runner({
	...
	setup: function() {
		doc = new Gridroad.Docsis(1038, 2393);
	},
	...
	testDigitalPhoneHasPublicRx: function() { with(this) {
		assert(parseInt(doc.rx, 10) === parseInt(1038, 10), "Expected 1038 but received: " + doc.tx);
	}},
